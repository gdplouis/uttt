...
public class Rules {
	 ...
	 * played spot. For a hight=2 board, the lineage is always only a single
	 ...
	 * <LI>{@code LINEAGE_GRAFT} - The contraint is.
	 ...
	 * selecting the sub-board with the move's row/col. Continue narrowing the contraint until
