 ...
 * determined, see {@link com.uttt.common.game.Rules.Constraint Rules.Constraint}, although a given implementation might
 ...
 * <P><B>Game:</B>
 *
 * A {@link com.uttt.common.game.Game Game} is comprised of only a few core elements: a configuration, an official
 ...
 * <P><B>Node:</B>
 *
 * Each {@link com.uttt.common.board.Node Node} represents a single position within some parent board - unless this is a
 ...
 *
 * A {@link com.uttt.common.board.Token Token} holds a spot as controlled (owned, taken) by a specific player. Tokens
 * may only be placed on bottom-boards. As a leaf in a board tree, tokens always have height=0.
 *
 * <P><B>Board (extends Node):</B>
 *
 * A {@link com.uttt.common.board.Board Board} is a square grid of {@code Node} elements, which can either be
 ...
 * {@link com.uttt.common.game.Rules.Constraint Constraint}), but they all share common aspects:
 *
 * <NL>
 *
 ...
 *
 * Each node will always be in one of several possible {@link com.uttt.common.board.Node.Status Status} states,
 ...
 * <P><B>Playability:</B>
 *
 * {@link com.uttt.common.board.Playable#isPlayable}.
 *
 * <HR>
 *
 * <P><B>QQQ:</B>
